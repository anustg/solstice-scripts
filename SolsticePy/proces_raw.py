...
def process_raw_results(rawfile, savedir,rho_mirror):
	...
	# 3 - 24 (total 22) front
	# 25- 46 (total 22) back 
	rec_area=get_rc(9,2) # m2  

	rec_front_income=get_rc(9,3)
	rec_front_income_err=get_rc(9,4)
	#rec_no_material_loss=get_rc(9,5)
	#rec_no_material_loss_err=get_rc(9,6)
	#rec_no_atmo_loss=get_rc(9,7)
	#rec_no_atmo_loss_err=get_rc(9,8)
	#rec_material_loss=get_rc(9,9)
	#rec_material_loss_err=get_rc(9,10)
	rec_front_absorbed=get_rc(9,13)
	rec_front_absorbed_err=get_rc(9,14)
	rec_front_eff=get_rc(9,23)
	rec_front_eff_err=get_rc(9,24)

	rec_back_income=get_rc(9,25)
	rec_back_income_err=get_rc(9,26)
	rec_back_absorbed=get_rc(9,35)
	rec_back_absorbed_err=get_rc(9,36)
	rec_back_eff=get_rc(9,-2)
	rec_back_eff_err=get_rc(9,-1)


	#Virtual target
	vir_area=get_rc(10,2)
	vir_income=get_rc(10,3)
	vir_income_err=get_rc(10,4)
...
>>>>>>> ab7f29f04365a68657b48c6229cf1224e16885bb:SolsticePy/proces_raw.py
